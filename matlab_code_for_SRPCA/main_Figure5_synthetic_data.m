...
T1 = fft(eye(n3)); T1 = T1/norm(T1);
T2 = dct(eye(n3));
T3 = dst(eye(n3)); T3 = T3/norm(T3);
T4 = hadamard(n3); T4 = T4/norm(T4);
T_combined = [T1; T2; T3; T4]/2; % a slim transform composed of 4 square transforms
