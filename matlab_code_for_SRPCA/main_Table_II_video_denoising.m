...
video = load('../data/Weizmann_testCR20.mat').Weizmann_testCR20;
n1 = 144;
n2 = 180; 
n3 = 28;
num_video = 10; % number of videos
...
PSNRs = zeros(1,num_video); 
parfor i = 1:num_video
    L_groundtruth = squeeze(video(i, 1, :, :, 1:n3)); % ground-truth low-rank tensor   
    M = squeeze(video(i, 2, :, :, 1:n3)); % M: observation tensor = low-rank tensor + sparse tensor
